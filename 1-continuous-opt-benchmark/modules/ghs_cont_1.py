...
def search(search_space, max_iter, HMS, HMCR, PARmin, PARmax, problem_size, total):
    ...
    for i in range(max_iter):
        ...
        # write fitness
        if not os.path.exists(os.path.join(os.getcwd(), 'data', 'ghs_cont_1')):
            os.mkdir(os.path.join(os.getcwd(), 'data', 'ghs_cont_1'))
        path0 = os.path.join(os.getcwd(), 'data', 'ghs_cont_1', 'fitness')
