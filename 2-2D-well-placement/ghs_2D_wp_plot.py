...
def search(search_space, max_iter, HMS, HMCR, PARmin, PARmax, total):
    ...
    for i in range(max_iter):
        ...
        # write fitness
        path0 = os.path.join(os.getcwd(), 'data', 'ghs_2D_wp', 'fitness')
        ...
        ## write coordinates
        path20 = os.path.join(os.getcwd(), 'data', 'ghs_2D_wp', 'vectors')
...
if __name__ == "__main__":
    ...
    if os.path.exists('results/ghs_2D_wp_plot_runtime.txt'):
        os.remove('results/ghs_2D_wp_plot_runtime.txt')

    path00 = os.path.join(os.getcwd(), 'data', 'ghs_2D_wp')
    ...
    with open("results/ghs_2D_wp_plot_runtime.txt", "a") as fout:
            t_start = time.time()
