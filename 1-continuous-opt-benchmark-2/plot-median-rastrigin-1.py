...
# data_hs = load('data/hs_cont_ra/fitness')
data_ghs = load('data/ghs_cont_ra/fitness')
data_ghs_1 = load('data/ghs_cont_ra_1/fitness')
# data_ghs_2 = load('data/ghs_cont_ra_2/fitness')
# data_ghs_3 = load('data/ghs_cont_ra_3/fitness')
# data_ghs_4 = load('data/ghs_cont_ra_4/fitness')
# data_ghs_5 = load('data/ghs_cont_ra_5/fitness')
# data_ghs_6 = load('data/ghs_cont_ra_6/fitness')
...
legend = legend(["ghs_cont_ra", "ghs_cont_ra_1"], loc=1)
...
fig.tight_layout()
savefig('plots/median_rastrigin-1.png')
show()